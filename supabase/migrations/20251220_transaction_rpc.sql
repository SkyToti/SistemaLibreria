...
-- Ejecuta este script para crear la función que maneja todo el proceso de venta en una sola transacción segura.
...
EXCEPTION WHEN OTHERS THEN
  -- Si algo falla, PostgreSQL hará rollback automático de toda la transacción
  RAISE;
END;
$$ LANGUAGE plpgsql;
